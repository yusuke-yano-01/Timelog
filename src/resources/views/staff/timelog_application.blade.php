...
@section('css')
<link rel="stylesheet" href="{{ asset('css/timelog_application.css') }}">
@endsection
...
<div class="application-container">
    ...
    <div class="application-tabs">
        <a href="{{ route('timelog.application', ['status' => 'pending']) }}" 
           class="tab-link {{ $status === 'pending' ? 'active' : '' }}">
            承認待ち
        </a>
        <a href="{{ route('timelog.application', ['status' => 'approved']) }}" 
